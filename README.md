...
Check the [releases](https://github.com/droboports/proftpd/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/proftpd.git
cd proftpd
./build.sh
ls -la *.tgz
```
